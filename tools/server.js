...
const allowed={'maps': path.join(root,'data/maps_unified.json'), 'items': path.join(root,'data/items_unified.json'), 'activities': path.join(root,'data/activities_db.json')};
app.post('/api/save/:type', (req,res)=>{
  ...
  // also update js wrapper if exists
  if (req.params.type !== 'activities') {
