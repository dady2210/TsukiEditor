// Shader Graphs/Foam
// sacado de sharedassets4.assets
// declara: White, _Distort, _DistortDamper, _MainTex, _Speed, unity_Lightmaps, unity_LightmapsInd, unity_ShadowMasks
...
UNITY_BINDING(1) uniform UnityPerMaterial {
	...
	UNITY_UNIFORM vec4 Xhlslcc_UnusedX_Distort_TexelSize;
	UNITY_UNIFORM float                _DistortDamper;
...
void main()
{
    ...
    u_xlat4.x = _TimeParameters.x * _Speed;
    u_xlat0.xy = u_xlat4.xx * vec2(0.100000001, 0.100000001) + u_xlat0.xy;
    u_xlat16_0.xy = texture(_Distort, u_xlat0.xy, _GlobalMipBias.x).xy;
    u_xlat4.xy = vs_INTERP0.xy + vec2(-0.5, -0.5);
    u_xlat0.xy = u_xlat16_0.xy * u_xlat4.xy;
    u_xlat0.xy = u_xlat0.xy + u_xlat0.xy;
    u_xlat0.xy = u_xlat0.xy / vec2(_DistortDamper);
    u_xlat16_4 = texture(_MainTex, vs_INTERP0.xy, _GlobalMipBias.x).w;
    u_xlat4.x = (-u_xlat16_4) + 1.0;
    u_xlat0.xy = u_xlat0.xy * u_xlat4.xx + vs_INTERP0.xy;
    u_xlat16_0 = texture(_MainTex, u_xlat0.xy, _GlobalMipBias.x);
    u_xlat1 = u_xlat16_0.w + u_xlat16_0.w;
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
    u_xlat16_0.w = roundEven(u_xlat1);
