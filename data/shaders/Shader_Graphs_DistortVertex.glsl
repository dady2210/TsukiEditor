// Shader Graphs/DistortVertex
// sacado de sharedassets1.assets
// declara: White, _MainTex, _Scale, _SpeedDamper, _StrengthDamper, _UVDistortDamper, unity_Lightmaps, unity_LightmapsInd, unity_ShadowMasks
...
UNITY_BINDING(0) uniform UnityPerMaterial {
	...
	UNITY_UNIFORM float                _UVDistortDamper;
...
void main()
{
    ...
    u_xlat5.xy = u_xlat0.yy * hlslcc_mtx4x4unity_ObjectToWorld[1].xy;
    u_xlat0.xy = hlslcc_mtx4x4unity_ObjectToWorld[0].xy * u_xlat0.xx + u_xlat5.xy;
    ...
    u_xlat10.x = _TimeParameters.x / _SpeedDamper;
    u_xlat1.xy = u_xlat10.xx + u_xlat0.xy;
    u_xlat0.xy = (-u_xlat10.xx) + u_xlat0.xy;
    u_xlat10.x = _GlobalDistort * _Scale;
    u_xlat1.xy = u_xlat10.xx * u_xlat1.xy;
    u_xlat0.xy = u_xlat10.xx * u_xlat0.xy;
    u_xlat10.xy = floor(u_xlat1.xy);
    u_xlat11.xy = u_xlat10.xy + vec2(1.0, 1.0);
    ...
    u_xlat1.zw = u_xlat11.xy * u_xlat2.zw;
    u_xlat1 = fract(u_xlat1);
    u_xlat11.xy = u_xlat1.zw * u_xlat2.xy;
    ...
    u_xlat13.xy = u_xlat1.xy * vec2(6.0, 6.0) + vec2(-15.0, -15.0);
    u_xlat13.xy = u_xlat1.xy * u_xlat13.xy + vec2(10.0, 10.0);
    ...
    u_xlat10.x = u_xlat10.x * u_xlat13.y;
    u_xlat10.x = fract(u_xlat10.x);
    u_xlat10.x = u_xlat13.x * u_xlat10.x + u_xlat10.y;
    u_xlat15 = u_xlat10.x * 34.0 + 1.0;
    u_xlat10.x = u_xlat10.x * u_xlat15;
    u_xlat15 = u_xlat10.x * 289.0;
    u_xlatb15 = u_xlat15>=(-u_xlat15);
    u_xlat13.xy = (bool(u_xlatb15)) ? vec2(289.0, 0.00346020772) : vec2(-289.0, -0.00346020772);
    u_xlat10.x = u_xlat10.x * u_xlat13.y;
    u_xlat10.x = fract(u_xlat10.x);
    ...
    u_xlat10.x = dot(u_xlat10.xy, u_xlat1.xy);
    ...
    u_xlat15 = u_xlat1.x * u_xlat15 + u_xlat2.y;
    u_xlat1.x = u_xlat15 * 34.0 + 1.0;
    ...
    u_xlat15 = fract(u_xlat15);
    u_xlat1.xy = vec2(u_xlat15) * vec2(2.0, 2.0) + vec2(-1.0, -0.5);
    u_xlat15 = floor(u_xlat1.y);
    u_xlat2.x = (-u_xlat15) + u_xlat1.x;
    u_xlat2.y = abs(u_xlat1.x) + -0.5;
    u_xlat15 = dot(u_xlat2.xy, u_xlat2.xy);
    u_xlat15 = inversesqrt(u_xlat15);
    u_xlat1.xy = vec2(u_xlat15) * u_xlat2.xy;
    u_xlat15 = dot(u_xlat1.xy, u_xlat3.xy);
    u_xlat15 = (-u_xlat10.x) + u_xlat15;
    u_xlat10.x = u_xlat12.y * u_xlat15 + u_xlat10.x;
    u_xlat15 = (-u_xlat10.x) + u_xlat11.x;
    u_xlat1.x = u_xlat12.x * u_xlat15 + u_xlat10.x;
    ...
    u_xlat0.x = u_xlat12.y * u_xlat5.x + u_xlat0.x;
    u_xlat5.x = (-u_xlat0.x) + u_xlat11.x;
    u_xlat1.y = u_xlat12.x * u_xlat5.x + u_xlat0.x;
    u_xlat0.xy = u_xlat1.xy * vec2(vec2(_GlobalDistort, _GlobalDistort));
    u_xlat0.xy = u_xlat0.xy / vec2(vec2(_StrengthDamper, _StrengthDamper));
    u_xlat0.xy = in_POSITION0.xy * unity_SpriteProps.xy + (-u_xlat0.xy);
    ...
    u_xlat15 = inversesqrt(u_xlat15);
    vs_INTERP3.xyz = vec3(u_xlat15) * u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat5.xy = u_xlat0.xx + vs_INTERP2.xy;
    u_xlat15 = _GlobalDistort * _Scale;
    ...
    u_xlatb2.x = u_xlat2.x>=(-u_xlat2.x);
    u_xlat3.xy = (u_xlatb2.x) ? vec2(289.0, 0.00346020772) : vec2(-289.0, -0.00346020772);
    u_xlat16 = u_xlat16 * u_xlat3.y;
    u_xlat16 = fract(u_xlat16);
    u_xlat16 = u_xlat3.x * u_xlat16 + u_xlat2.y;
    ...
    u_xlat4 = u_xlat5.xyxy + vec4(-0.0, -1.0, -1.0, -0.0);
    ...
    u_xlat2.x = u_xlat12.x * u_xlat2.x + u_xlat2.y;
    ...
    u_xlat3 = u_xlat1.xyxy * vec4(289.0, 289.0, 289.0, 289.0);
    u_xlatb3 = greaterThanEqual(u_xlat3, (-u_xlat3.zwzw));
    u_xlat3.x = (u_xlatb3.x) ? float(289.0) : float(-289.0);
    u_xlat3.y = (u_xlatb3.y) ? float(289.0) : float(-289.0);
    u_xlat3.z = (u_xlatb3.z) ? float(0.00346020772) : float(-0.00346020772);
    u_xlat3.w = (u_xlatb3.w) ? float(0.00346020772) : float(-0.00346020772);
    u_xlat1.xy = u_xlat1.xy * u_xlat3.zw;
    ...
    u_xlat1.x = u_xlat7.x * u_xlat1.x + u_xlat1.y;
    u_xlat6 = u_xlat1.x * 34.0 + 1.0;
    u_xlat1.x = u_xlat1.x * u_xlat6;
    u_xlat6 = u_xlat1.x * 289.0;
    u_xlatb6 = u_xlat6>=(-u_xlat6);
    u_xlat7.xy = (bool(u_xlatb6)) ? vec2(289.0, 0.00346020772) : vec2(-289.0, -0.00346020772);
    u_xlat1.x = u_xlat1.x * u_xlat7.y;
    u_xlat1.x = fract(u_xlat1.x);
    u_xlat1.x = u_xlat1.x * u_xlat7.x;
    ...
    u_xlat7.xy = u_xlat5.xy * u_xlat7.xy;
    u_xlat3.xy = u_xlat5.xy * vec2(6.0, 6.0) + vec2(-15.0, -15.0);
    u_xlat5.xy = u_xlat5.xy * u_xlat3.xy + vec2(10.0, 10.0);
    u_xlat5.xy = u_xlat5.xy * u_xlat7.xy;
    u_xlat6 = (-u_xlat11.x) + u_xlat16;
    u_xlat6 = u_xlat5.y * u_xlat6 + u_xlat11.x;
    u_xlat1.x = (-u_xlat2.x) + u_xlat1.x;
    u_xlat10.x = u_xlat5.y * u_xlat1.x + u_xlat2.x;
    u_xlat10.x = (-u_xlat6) + u_xlat10.x;
    u_xlat1.x = u_xlat5.x * u_xlat10.x + u_xlat6;
    u_xlat0.xy = (-u_xlat0.xx) + vs_INTERP2.xy;
    ...
    u_xlat2.z = (u_xlatb2.z) ? float(0.00346020772) : float(-0.00346020772);
    u_xlat2.w = (u_xlatb2.w) ? float(0.00346020772) : float(-0.00346020772);
    u_xlat11.xy = u_xlat10.xy * u_xlat2.zw;
    u_xlat11.xy = fract(u_xlat11.xy);
    u_xlat11.xy = u_xlat11.xy * u_xlat2.xy;
    u_xlat2.x = u_xlat11.x * 34.0 + 1.0;
    u_xlat11.x = u_xlat11.x * u_xlat2.x;
    ...
    u_xlat11.x = inversesqrt(u_xlat11.x);
    u_xlat11.xy = u_xlat11.xx * u_xlat2.xy;
    u_xlat11.x = dot(u_xlat11.xy, u_xlat0.xy);
    u_xlat2 = u_xlat10.xyxy + vec4(0.0, 1.0, 1.0, 0.0);
    u_xlat3 = u_xlat2 * vec4(289.0, 289.0, 289.0, 289.0);
    u_xlatb3 = greaterThanEqual(u_xlat3, (-u_xlat3));
    u_xlat4.x = (u_xlatb3.x) ? float(289.0) : float(-289.0);
    ...
    u_xlat3 = u_xlat10.xyxy * vec4(289.0, 289.0, 289.0, 289.0);
    u_xlatb3 = greaterThanEqual(u_xlat3, (-u_xlat3.zwzw));
    u_xlat3.x = (u_xlatb3.x) ? float(289.0) : float(-289.0);
    u_xlat3.y = (u_xlatb3.y) ? float(289.0) : float(-289.0);
    u_xlat3.z = (u_xlatb3.z) ? float(0.00346020772) : float(-0.00346020772);
    u_xlat3.w = (u_xlatb3.w) ? float(0.00346020772) : float(-0.00346020772);
    u_xlat10.xy = u_xlat10.xy * u_xlat3.zw;
    u_xlat10.xy = fract(u_xlat10.xy);
    u_xlat10.xy = u_xlat10.xy * u_xlat3.xy;
    u_xlat7.x = u_xlat10.x * 34.0 + 1.0;
    u_xlat10.x = u_xlat10.x * u_xlat7.x;
    u_xlat7.x = u_xlat10.x * 289.0;
    u_xlatb7 = u_xlat7.x>=(-u_xlat7.x);
    u_xlat7.xy = (bool(u_xlatb7)) ? vec2(289.0, 0.00346020772) : vec2(-289.0, -0.00346020772);
    u_xlat10.x = u_xlat10.x * u_xlat7.y;
    u_xlat10.x = fract(u_xlat10.x);
    u_xlat10.x = u_xlat7.x * u_xlat10.x + u_xlat10.y;
    u_xlat15 = u_xlat10.x * 34.0 + 1.0;
    u_xlat10.x = u_xlat10.x * u_xlat15;
    u_xlat15 = u_xlat10.x * 289.0;
    u_xlatb15 = u_xlat15>=(-u_xlat15);
    u_xlat7.xy = (bool(u_xlatb15)) ? vec2(289.0, 0.00346020772) : vec2(-289.0, -0.00346020772);
    u_xlat10.x = u_xlat10.x * u_xlat7.y;
    u_xlat10.x = fract(u_xlat10.x);
    u_xlat10.x = u_xlat10.x * u_xlat7.x;
    u_xlat10.x = u_xlat10.x * 0.024390243;
    ...
    u_xlat10.x = dot(u_xlat10.xy, u_xlat7.xy);
    ...
    u_xlat15 = (-u_xlat11.x) + u_xlat16;
    u_xlat15 = u_xlat0.y * u_xlat15 + u_xlat11.x;
    u_xlat10.x = (-u_xlat2.x) + u_xlat10.x;
    u_xlat5.x = u_xlat0.y * u_xlat10.x + u_xlat2.x;
    u_xlat5.x = (-u_xlat15) + u_xlat5.x;
    u_xlat1.y = u_xlat0.x * u_xlat5.x + u_xlat15;
    u_xlat0.xy = u_xlat1.xy * vec2(vec2(_GlobalDistort, _GlobalDistort));
    u_xlat0.xy = u_xlat0.xy / vec2(vec2(_StrengthDamper, _StrengthDamper));
    u_xlat0.xy = u_xlat0.xy / vec2(vec2(_UVDistortDamper, _UVDistortDamper));
