...
// declara: White, _BaseDistortDamper, _BaseOffset, _BaseSpeedDamper, _CausticColor, _CausticScale, _MainTex, _NormalDistort, _SecondaryTex, _Speed, _SpeedY, _TintA, _TintB, _WaterScale, unity_Lightmaps, unity_LightmapsInd, unity_ShadowMasks
...
UNITY_BINDING(0) uniform UnityPerMaterial {
	...
	UNITY_UNIFORM float                _BaseDistortDamper;
	UNITY_UNIFORM float                _BaseSpeedDamper;
	UNITY_UNIFORM vec4 Xhlslcc_UnusedX_SecondaryTex_TexelSize;
	UNITY_UNIFORM vec4                _CausticColor;
	UNITY_UNIFORM float                _CausticScale;
	UNITY_UNIFORM float Xhlslcc_UnusedX_NormalDistort;
	UNITY_UNIFORM float Xhlslcc_UnusedX_SpeedY;
	UNITY_UNIFORM vec2                _Speed;
	UNITY_UNIFORM vec2                _BaseOffset;
	UNITY_UNIFORM float                _WaterScale;
	UNITY_UNIFORM vec4                _TintA;
	UNITY_UNIFORM vec4                _TintB;
...
void main()
{
    u_xlat0.x = _GlobalDistort / _BaseSpeedDamper;
    u_xlat5 = dot(u_xlat0.xx, _TimeParameters.xx);
    u_xlat10.xy = vs_INTERP2.xy + vec2(_BaseOffset.x, _BaseOffset.y);
    u_xlat1.xy = u_xlat10.xy + vec2(u_xlat5);
    u_xlat1.xy = u_xlat1.xy * vec2(_WaterScale);
    ...
    u_xlat1.xy = _TimeParameters.xx * _Speed.xy;
    u_xlat1.xy = u_xlat0.xx * u_xlat1.xy;
    u_xlat0.x = _CausticScale * _WaterScale;
    u_xlat0.xz = u_xlat10.xy * u_xlat0.xx + u_xlat1.xy;
    u_xlat1.xy = vec2(_BaseOffset.x, _BaseOffset.y) * vec2(0.285714298, 0.285714298) + u_xlat1.xy;
    u_xlat1.xy = u_xlat1.xy + vs_INTERP0.xy;
    u_xlat0.xz = vec2(u_xlat5) * vec2(0.100000001, 0.100000001) + u_xlat0.xz;
    u_xlat5 = u_xlat5 + 0.5;
    u_xlat16_2 = texture(_SecondaryTex, u_xlat0.xz, _GlobalMipBias.x);
    u_xlat0.x = u_xlat5 * u_xlat16_2.w;
    u_xlat0.xzw = u_xlat0.xxx * u_xlat16_2.xyz;
    u_xlat11.x = u_xlat5 / _BaseDistortDamper;
    u_xlat1.xy = u_xlat1.xy + u_xlat11.xx;
    u_xlat16_1.xyz = texture(_MainTex, u_xlat1.xy, _GlobalMipBias.x).xyz;
    u_xlat2.xyz = (-_TintA.xyz) + _TintB.xyz;
    u_xlat2.xyz = vec3(u_xlat5) * u_xlat2.xyz + _TintA.xyz;
    u_xlat2.xyz = (-u_xlat16_1.xyz) + u_xlat2.xyz;
    u_xlat5 = (-_WaterScale) + 1.0;
    u_xlat5 = u_xlat5 / _WaterScale;
    u_xlat1.xyz = vec3(u_xlat5) * u_xlat2.xyz + u_xlat16_1.xyz;
    u_xlat0.xyz = _CausticColor.xyz * u_xlat0.xzw + u_xlat1.xyz;
    u_xlat0.w = 1.0;
