// Shader Graphs/GenericWindowReveal
// sacado de sharedassets70.assets
// declara: White, _Edge, _MainTex, _RevealOffset, _RevealThreshold, unity_Lightmaps, unity_LightmapsInd, unity_ShadowMasks
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat6.x = dot(u_xlat3.yx, vec2(12.9898005, 78.2330017));
    u_xlat6.x = u_xlat6.x * 0.159154937;
    u_xlatb2 = u_xlat6.x>=(-u_xlat6.x);
    u_xlat6.x = fract(abs(u_xlat6.x));
    u_xlat6.x = (u_xlatb2) ? u_xlat6.x : (-u_xlat6.x);
    ...
    u_xlat1.x = u_xlat0.x * u_xlat6.x + u_xlat1.x;
    u_xlat6.x = (-u_xlat2.x) + u_xlat2.w;
    u_xlat6.x = u_xlat0.x * u_xlat6.x + u_xlat2.x;
    ...
    u_xlat1.x = sin(u_xlat1.x);
    u_xlat1.x = u_xlat1.x * 43758.5469;
    u_xlat6.x = dot(u_xlat3.wz, vec2(12.9898005, 78.2330017));
    u_xlat6.x = u_xlat6.x * 0.159154937;
    u_xlatb2 = u_xlat6.x>=(-u_xlat6.x);
    u_xlat6.x = fract(abs(u_xlat6.x));
    u_xlat6.x = (u_xlatb2) ? u_xlat6.x : (-u_xlat6.x);
    ...
    u_xlat6.x = (-u_xlat1.x) + u_xlat1.y;
    u_xlat1.x = u_xlat0.y * u_xlat6.x + u_xlat1.x;
    u_xlat6.x = (-u_xlat2.x) + u_xlat2.y;
    u_xlat6.x = u_xlat0.y * u_xlat6.x + u_xlat2.x;
    u_xlat6.x = (-u_xlat1.x) + u_xlat6.x;
    u_xlat5 = u_xlat0.y * u_xlat6.x + u_xlat1.x;
    ...
    u_xlat6.x = u_xlat6.x * 0.159154937;
    u_xlatb7 = u_xlat6.x>=(-u_xlat6.x);
    u_xlat6.x = fract(abs(u_xlat6.x));
    u_xlat6.x = (u_xlatb7) ? u_xlat6.x : (-u_xlat6.x);
    u_xlat6.x = u_xlat6.x * 6.28318548;
    u_xlat6.x = sin(u_xlat6.x);
    u_xlat1.y = u_xlat6.x * 43758.5469;
    u_xlat1.xy = fract(u_xlat1.xy);
    ...
    u_xlat6.x = (-u_xlat1.x) + u_xlat1.y;
    u_xlat1.x = u_xlat0.z * u_xlat6.x + u_xlat1.x;
    ...
    u_xlat10.x = (-u_xlat10.x) * 0.600000024 + u_xlat11;
    u_xlat15 = (-vs_INTERP1.w) + 1.0;
    u_xlat1.x = (-u_xlat10.x) + u_xlat11;
    u_xlat10.x = u_xlat15 * u_xlat1.x + u_xlat10.x;
    u_xlat1.xy = vs_INTERP2.xy + (-_RevealOffset.xy);
    u_xlat15 = dot(u_xlat1.xy, u_xlat1.xy);
    u_xlat15 = u_xlat15 + (-_RevealThreshold);
    u_xlat1.x = ceil(u_xlat15);
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat2.w = u_xlat10.x * u_xlat1.x;
    u_xlatb10 = u_xlat2.w==0.0;
    if(u_xlatb10){discard;}
    u_xlat6.xyz = (u_xlatb0.x) ? vec3(0.174647495, 0.423267812, 0.428690612) : vec3(0.238397703, 0.571124971, 0.577580571);
    u_xlat3.xyz = (u_xlatb0.x) ? vec3(0.227330402, 0.567834377, 0.571309388) : vec3(0.163580194, 0.419977248, 0.422419429);
    u_xlat0.xyz = vec3(u_xlat5) * u_xlat3.xyz + u_xlat6.xyz;
    u_xlat0.xyz = log2(u_xlat0.xyz);
    u_xlat0.xyz = u_xlat0.xyz * vec3(0.416666657, 0.416666657, 0.416666657);
    u_xlat0.xyz = exp2(u_xlat0.xyz);
    u_xlat0.xyz = u_xlat0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
    u_xlat6.xy = vs_INTERP1.ww * vec2(-0.200000048, 0.5) + vec2(1.20000005, 0.5);
    u_xlat0.xyz = u_xlat0.xyz / u_xlat6.xxx;
    u_xlat6.x = dot(u_xlat0.xyz, vec3(0.212672904, 0.715152204, 0.0721750036));
    u_xlat0.xyz = u_xlat0.xyz + (-u_xlat6.xxx);
    u_xlat0.xyz = u_xlat6.yyy * u_xlat0.xyz + u_xlat6.xxx;
    u_xlat15 = max(u_xlat15, 0.0);
    u_xlat6.x = sqrt(_RevealThreshold);
    u_xlat15 = (-u_xlat6.x) * 0.100000001 + u_xlat15;
    u_xlat15 = ceil((-u_xlat15));
    u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
    u_xlat15 = u_xlat15 * u_xlat1.x;
    u_xlat1.xyz = (-u_xlat0.xyz) + vec3(0.300000012, 0.300000012, 0.300000012);
    u_xlat2.xyz = vec3(u_xlat15) * u_xlat1.xyz + u_xlat0.xyz;
    SV_TARGET0 = u_xlat2;
    return;
}
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat5.xy = vs_INTERP2.yy * unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_WorldToObjectArray[1].xy;
    u_xlat5.xy = unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_WorldToObjectArray[0].xy * vs_INTERP2.xx + u_xlat5.xy;
    u_xlat5.xy = unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_WorldToObjectArray[2].xy * vs_INTERP2.zz + u_xlat5.xy;
    u_xlat5.xy = u_xlat5.xy + unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_WorldToObjectArray[3].xy;
    u_xlatb15 = 0.0<_ProjectionParams.x;
    u_xlat1.x = (-hlslcc_FragCoord.y) + _ScaledScreenParams.y;
    u_xlat1.y = (u_xlatb15) ? u_xlat1.x : hlslcc_FragCoord.y;
    u_xlat1.x = hlslcc_FragCoord.x;
    ...
    u_xlat0.x = dot(unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[1].xyz, unity_Builtins0Array[u_xlati0 / 8].hlslcc_mtx4x4unity_ObjectToWorldArray[1].xyz);
    u_xlat0.x = sqrt(u_xlat0.x);
    u_xlat11 = -0.5 / u_xlat0.x;
    u_xlat16 = u_xlat11 * u_xlat6.x;
    u_xlat2.x = vs_INTERP0.x * u_xlat16 + vs_INTERP0.y;
    u_xlat7 = ceil(u_xlat2.x);
    u_xlat11 = (-u_xlat6.x) * u_xlat11 + vs_INTERP0.y;
    u_xlat11 = vs_INTERP0.x * u_xlat16 + u_xlat11;
    u_xlat11 = floor(u_xlat11);
    u_xlat11 = (-u_xlat11) + u_xlat7;
    u_xlat16 = _Edge / u_xlat6.x;
    u_xlat12 = u_xlat16 + vs_INTERP0.x;
    u_xlat12 = floor(u_xlat12);
    u_xlat17 = _Edge / u_xlat0.x;
    u_xlat3.x = (-u_xlat17) + u_xlat2.x;
    u_xlat3.x = ceil(u_xlat3.x);
    u_xlat3.x = u_xlat7 + (-u_xlat3.x);
    u_xlat12 = u_xlat12 + u_xlat3.x;
    ...
    u_xlat1.w = u_xlat16 + u_xlat12;
    u_xlat2.x = _ScreenParams.y / _ScreenParams.x;
    u_xlat15 = u_xlat2.x * u_xlat15 + u_xlat1.x;
    u_xlat2.xyz = vec3(u_xlat15) * vec3(40.0, 20.0, 10.0);
    u_xlat3.xyz = floor(u_xlat2.xyz);
    u_xlat2.xyz = fract(u_xlat2.xyz);
    u_xlat4.xyz = u_xlat2.xyz * u_xlat2.xyz;
    u_xlat2.xyz = (-u_xlat2.xyz) * vec3(2.0, 2.0, 2.0) + vec3(3.0, 3.0, 3.0);
    ...
    u_xlat1.x = u_xlat2.x * u_xlat17 + u_xlat1.x;
    u_xlat17 = (-u_xlat3.x) + u_xlat3.w;
    u_xlat17 = u_xlat2.x * u_xlat17 + u_xlat3.x;
    u_xlat17 = (-u_xlat1.x) + u_xlat17;
    u_xlat1.x = u_xlat2.x * u_xlat17 + u_xlat1.x;
    ...
    u_xlat2.x = u_xlat2.y * u_xlat17 + u_xlat2.x;
    u_xlat2.x = u_xlat2.x * 0.25;
    u_xlat1.x = u_xlat1.x * 0.125 + u_xlat2.x;
    u_xlat2.xy = u_xlat3.zz + vec2(0.0, 1.0);
    u_xlat17 = dot(u_xlat3.zz, vec2(12.9898005, 78.2330017));
    u_xlat17 = u_xlat17 * 0.159154937;
    u_xlatb3 = u_xlat17>=(-u_xlat17);
    ...
    u_xlat2.x = (-u_xlat17) + u_xlat2.x;
    u_xlat2.x = u_xlat2.z * u_xlat2.x + u_xlat17;
    u_xlat1.x = u_xlat2.x * 0.5 + u_xlat1.x;
    u_xlat1.x = fract(u_xlat1.x);
    ...
    u_xlat0.xyz = (-u_xlat0.xyz) * vec3(2.0, 2.0, 2.0) + vec3(3.0, 3.0, 3.0);
    u_xlat0.xyz = u_xlat0.xyz * u_xlat3.xyz;
    u_xlat3 = u_xlat2.xxyy + vec4(1.0, 0.0, 0.0, 1.0);
    ...
    u_xlat2.x = dot(u_xlat3.yx, vec2(12.9898005, 78.2330017));
    u_xlat2.x = u_xlat2.x * 0.159154937;
    u_xlatb17 = u_xlat2.x>=(-u_xlat2.x);
    u_xlat2.x = fract(abs(u_xlat2.x));
    u_xlat2.x = (u_xlatb17) ? u_xlat2.x : (-u_xlat2.x);
    ...
    u_xlat2.x = sin(u_xlat2.x);
    u_xlat2.x = u_xlat2.x * 43758.5469;
    u_xlat17 = dot(u_xlat3.xx, vec2(12.9898005, 78.2330017));
    u_xlat17 = u_xlat17 * 0.159154937;
    u_xlatb3 = u_xlat17>=(-u_xlat17);
    u_xlat17 = fract(abs(u_xlat17));
    u_xlat17 = (u_xlatb3) ? u_xlat17 : (-u_xlat17);
    ...
    u_xlat15 = u_xlat0.x * u_xlat6.x + u_xlat15;
    u_xlat6.x = (-u_xlat2.x) + u_xlat2.w;
    u_xlat6.x = u_xlat0.x * u_xlat6.x + u_xlat2.x;
    u_xlat6.x = (-u_xlat15) + u_xlat6.x;
    u_xlat0.x = u_xlat0.x * u_xlat6.x + u_xlat15;
    u_xlat15 = dot(u_xlat2.yy, vec2(12.9898005, 78.2330017));
    u_xlat15 = u_xlat15 * 0.159154937;
    u_xlatb6 = u_xlat15>=(-u_xlat15);
    u_xlat15 = fract(abs(u_xlat15));
    u_xlat15 = (u_xlatb6) ? u_xlat15 : (-u_xlat15);
    ...
    u_xlat2.xy = fract(u_xlat2.xy);
    u_xlat6.x = (-u_xlat15) + u_xlat6.x;
    u_xlat15 = u_xlat0.y * u_xlat6.x + u_xlat15;
    u_xlat6.x = (-u_xlat2.x) + u_xlat2.y;
    u_xlat6.x = u_xlat0.y * u_xlat6.x + u_xlat2.x;
    u_xlat6.x = (-u_xlat15) + u_xlat6.x;
    ...
    u_xlat5.xz = u_xlat2.zz + vec2(0.0, 1.0);
    u_xlat6.x = dot(u_xlat2.zz, vec2(12.9898005, 78.2330017));
    u_xlat6.x = u_xlat6.x * 0.159154937;
    u_xlatb2 = u_xlat6.x>=(-u_xlat6.x);
    u_xlat6.x = fract(abs(u_xlat6.x));
    u_xlat6.x = (u_xlatb2) ? u_xlat6.x : (-u_xlat6.x);
    ...
    u_xlat6.x = u_xlat6.x * 43758.5469;
    u_xlat6.x = fract(u_xlat6.x);
    u_xlat2.x = dot(u_xlat5.zx, vec2(12.9898005, 78.2330017));
    u_xlat2.x = u_xlat2.x * 0.159154937;
    u_xlatb7 = u_xlat2.x>=(-u_xlat2.x);
    u_xlat2.x = fract(abs(u_xlat2.x));
    u_xlat2.x = (u_xlatb7) ? u_xlat2.x : (-u_xlat2.x);
    ...
    u_xlat5.x = (u_xlatb7) ? u_xlat5.x : (-u_xlat5.x);
    u_xlat5.x = u_xlat5.x * 6.28318548;
    u_xlat5.x = sin(u_xlat5.x);
    u_xlat5.x = u_xlat5.x * 43758.5469;
    u_xlat15 = dot(u_xlat5.zz, vec2(12.9898005, 78.2330017));
    u_xlat15 = u_xlat15 * 0.159154937;
    u_xlatb7 = u_xlat15>=(-u_xlat15);
    u_xlat15 = fract(abs(u_xlat15));
    u_xlat15 = (u_xlatb7) ? u_xlat15 : (-u_xlat15);
    u_xlat15 = u_xlat15 * 6.28318548;
    u_xlat15 = sin(u_xlat15);
    u_xlat5.z = u_xlat15 * 43758.5469;
    u_xlat5.xz = fract(u_xlat5.xz);
    u_xlat2.x = (-u_xlat6.x) + u_xlat2.x;
    u_xlat6.x = u_xlat0.z * u_xlat2.x + u_xlat6.x;
    u_xlat15 = (-u_xlat5.x) + u_xlat5.z;
    u_xlat5.x = u_xlat0.z * u_xlat15 + u_xlat5.x;
    u_xlat5.x = (-u_xlat6.x) + u_xlat5.x;
    u_xlat5.x = u_xlat0.z * u_xlat5.x + u_xlat6.x;
    ...
    u_xlat10.xy = (u_xlatb0.x) ? vec2(0.686274529, 0.313725471) : vec2(0.784313679, 0.215686321);
    u_xlat10.x = u_xlat5.x * u_xlat10.y + u_xlat10.x;
    u_xlat10.x = (-u_xlat10.x) * 0.600000024 + u_xlat11;
    u_xlat15 = (-vs_INTERP1.w) + 1.0;
    u_xlat1.x = (-u_xlat10.x) + u_xlat11;
    u_xlat10.x = u_xlat15 * u_xlat1.x + u_xlat10.x;
    ...
    u_xlat6.xyz = (u_xlatb0.x) ? vec3(0.174647495, 0.423267812, 0.428690612) : vec3(0.238397703, 0.571124971, 0.577580571);
    u_xlat3.xyz = (u_xlatb0.x) ? vec3(0.227330402, 0.567834377, 0.571309388) : vec3(0.163580194, 0.419977248, 0.422419429);
    u_xlat0.xyz = u_xlat5.xxx * u_xlat3.xyz + u_xlat6.xyz;
    u_xlat0.xyz = log2(u_xlat0.xyz);
    u_xlat0.xyz = u_xlat0.xyz * vec3(0.416666657, 0.416666657, 0.416666657);
    u_xlat0.xyz = exp2(u_xlat0.xyz);
    u_xlat0.xyz = u_xlat0.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
...
#endif
         ºu
                         INSTANCING_ON      SKINNED_SPRITE  kX  #ifdef VERTEX
